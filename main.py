...
st.markdown("""
    ...
    /* Rimuove lo spazio verticale tra i container degli elementi st.columns */
    [data-testid="stVerticalBlock"] > div > div[data-testid="stVerticalBlock"] > div.stElementContainer {
        margin-bottom: -1rem !important;
    }
    
    /* Rimuove hr originali nella lista risultati */
    hr { margin: 0.3rem 0 !important; border: 0; border-top: 1px solid rgba(255,255,255,0.08) !important; }
    
    /* Specifica per la lista mazzo: rimuove margini aggiuntivi dei markdown interni */
    .stMarkdown p {
...
CREST_ICONS = {
    ...
    "Holy": f"""<svg viewBox="0 0 24 24" width="{ICON_SIZE}" height="{ICON_SIZE}"><path d="M5,2H19V4L15,9V18H17V20H7V18H9V9L5,4V2Z" fill="#C0C0C0" stroke="#808080" stroke-width="1"/></svg>""",
